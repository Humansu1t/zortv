...
const ANIM_END_EVENT = 'webkitAnimationEnd animationend';
...
$(document).ready(function() {
    ...
    const tvShowsSwiper = new Swiper('.tv-shows-swiper', {
        speed: 400,
        spaceBetween: 1000,
        loop: true,
        effect: 'slide',
        ...
        navigation: {
            nextEl: '.tv-shows .swiper-button-next',
            prevEl: '.tv-shows .swiper-button-prev',
        },
        ...
        on: {
            slideChangeTransitionStart: function(s) {
                ...
                elems.each(function() {
                    ...
                    $this.addClass(animationType, 100).on(ANIM_END_EVENT, function() {
    ...
    const aboutTeamSlider = new Swiper('.about-team-slider', {
        effect: 'slide',
        speed: 400,
        loop: true,
        navigation: {
            nextEl: '.about-team-slider .swiper-button-next',
            prevEl: '.about-team-slider .swiper-button-prev',
        },
        slidesPerView: 3,
        breakpoints: {
            992: {
    ...
    const castingSlider = new Swiper('.casting-form-swiper', {
        effect: 'flip',
        speed: 400,
        loop: true,
        navigation: {
            nextEl: '.casting-form-swiper .swiper-button-next',
            prevEl: '.casting-form-swiper .swiper-button-prev',
        },
        slidesPerView: 1
    })
    const gallerySwiper = new Swiper('.gallery-units-section .swiper-container', {
        effect: 'slide',
        slidesPerView: 1,
        // loop: true,
        navigation: {
            nextEl: '.gallery-units-section .swiper-button-next',
            prevEl: '.gallery-units-section .swiper-button-prev',
        },
    })
    const tvNewsSwiper = new Swiper('.news-swiper .swiper-container', {
        effect: 'slide',
        loop: true,
        slidesPerView: 1,
        navigation: {
            nextEl: '[name="remote"] area:nth-child(3)',
            prevEl: '[name="remote"] area:nth-child(2)',
        }
    })
    $('.ballot__rate input[type="radio"]').click(function(e) {
        console.log(e);
        var parent = $(this).closest('.ballot__rate');
        ...
        post('/ajax/rate-poll', {
            ...
            if (r.state == "OK") {
                console.log(r);
                parent.closest('.ballot').addClass('voted');
            }
        });
        return true;
    });

    $('.program-tab__nav__item').click(function() {
        $(this).addClass('active').siblings().removeClass('active');
        $('.program-tab-content > li').hide().eq($(this).index()).show();
        return false;
    });
    $('[name="remote"] area:first-child').click(function() {
        $('.news-main').toggleClass('active');
        return false;
    })
    if (screen.width < 576) {
    ...
    $('.gallery-tile:not(.gallery-folders)').magnificPopup({
        delegate: 'a',
        type: 'image',
        image: {
        ...
        gallery: {
            enabled: true,
            arrowMarkup: '<button type="button">%title%</button>',
        },
        callbacks: {
            buildControls: function() {
                let arrowWrapper = document.createElement('div');
                arrowWrapper.classList.add('arrows-wrapper');
                arrowWrapper.append(this.arrowLeft[0]);
                arrowWrapper.append(this.arrowRight[0]);
                this.contentContainer.append(arrowWrapper);
            }
        }
    })
});
...
$(window).on('load', function() {
    ...
    (function() {
        let selector = '.program-main__wrapper h1';
        let length = $(selector).text().length;
        if (length >= 5) {
            $('.program-main__wrapper h1').css('font-size', '25rem');
        }
        if (length >= 10) {
            $('.program-main__wrapper h1').css('font-size', '20rem');
        }
        if (length >= 15) {
            $('.program-main__wrapper h1').css('font-size', '14rem');
        }
    })();
})